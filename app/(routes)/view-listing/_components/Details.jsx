import GoogleMapSection from '@/app/_component/GoogleMapSection'
import { Button } from '@/components/ui/button'
import { Bath, BedDouble, CarFront, Drill, Home, LandPlot, MapPin, Phone, Share } from 'lucide-react'
...
const Details = ({listingDetail}) => {
  return listingDetail && (
    <div className='my-6 flex gap-2 flex-col'>
        ...
        <div className='pt-3'>
        <h2 className="flex gap-2 items-center font-bold text-2xl">Contact Agent <Phone /></h2>
