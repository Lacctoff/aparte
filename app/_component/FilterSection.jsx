  ...
  return (
    <div className='px-3 py-2 grid grid-cols-2 md:flex gap-2'>
        <Select onValueChange={setBedCount}>
            ...
            <SelectContent>
                <SelectItem value="1">
                    <h2 className='flex gap-2'><Bed className='h-5 w-5 text-primary'/>1</h2>
                </SelectItem>
                <SelectItem value="2">
        ...
        <Select onValueChange={setBathCount}>
            ...
            <SelectContent>
                <SelectItem value="1">
                    <h2 className='flex gap-2'><Bath className='h-5 w-5 text-primary'/>1+</h2>
                </SelectItem>
                <SelectItem value="2">
        ...
        <Select onValueChange={setParkingCount}>
            ...
            <SelectContent>
                ...
                <SelectItem value="5">
                    <h2 className='flex gap-2'><CarFront className='h-5 w-5 text-primary'/>5+</h2>
                </SelectItem>
            </SelectContent>
        </Select>
