...
const Header = () => {
  ...
  //we are getting user info also supplied by clerk
    ...
    <div className='p-6 px-10 flex justify-between shadow-sm fixed top-0 w-full z-10 bg-white'>
      <div className='flex gap-12 items-center'>
        <Link href={'/'} className='flex   items-center '>
          ...
          <span className='text-yellow-500 font-extrabold text-xl'>APARTE</span>
        </Link>
      ...
      <div className='flex gap-2 items-center'>
        <Link href='/add-new-listing' className='hidden md:flex'>
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem> <Link href={'/add-new-listing'}>Post Your Ad</Link> </DropdownMenuItem>
